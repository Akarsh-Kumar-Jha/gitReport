...
export const FeatureStrip = () => {
  ...
  return (
    <div className="w-full max-w-3xl grid grid-cols-3 gap-2 sm:gap-3 mt-2 sm:mt-4">
      {features.map((item, idx) => {
        const IconComponent = item.icon;
        return (
          <div key={idx} className="bg-[#FFFFFF] border-brutal p-2 sm:p-2.5 flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-1.5 sm:gap-2.5 shadow-brutal-sm">
            <div className="bg-[#C8FF00] p-1.5 border border-[#0A0A0A] shrink-0">
